...
function agregarNumeros(arrayOfNums) {
   ...
   if (Array.isArray(arrayOfNums) && arrayOfNums.length > 0) {
      ...
      return 'El parámetro debe ser un arreglo de números con al menos un elemento.';
    }
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
 return (resultadosTest.reduce (function (acc, element) {
   return acc + element; } ) / resultadosTest.length)
 }
